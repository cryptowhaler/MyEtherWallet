    ...
    <div class="block-progressbar">
      <dir class="block-progressbar__container">
        ...
        <div class="block-progressbar__content">
          ...
          <p>
            Did you read that? YOU are the one who is in control. MEW is not a
            bank or exchange, we are an interface. This means we don't hold your
            keys or information, but it also means we can't access accounts,
